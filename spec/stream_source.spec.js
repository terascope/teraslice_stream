...
// const {
//     Stream, isStream, isStreamEntity, StreamEntity
// } = require('../');
//
// describe('StreamSource', () => {
//     describe('when constructed', () => {
//         it('should return a stream source', () => {
//             const sut = new Stream();
...
//             expect(() => new Stream(input)).toThrowError('Stream requires an array of StreamEntities as input');
//         });
//     });
//
//     describe('->count', () => {
...
//                 sut.write(null, (err) => {
//                     expect(err.message).toEqual('Stream->write() requires data to be any of the following types a Buffer, Object, Array, or String');
//                     done();
//                 });
//             });
//         });
...
//                 expect(() => sut.write({ hello: true })).toThrowError('Stream->write() requires a callback');
//             });
//         });
//
